...
def solve():
    ...
    for i in range(n):
        ...
        while mv:
            ...
            if val%2:
                to_add += (n-ones_bits[ptr]) *(2** (abs(ptr)-1))
                # print("1:",n-ones_bits[ptr])

            else:
                to_add += ones_bits[ptr] *(2**(abs(ptr)-1))
                # print("0:",ones_bits[ptr])
            val //= 2
            mv //= 2
            ptr -= 1
        # print("debug:",i, to_add)
